...
import { Search, MapPin, ArrowRight, Briefcase, FolderKanban, Building2, ChevronLeft, ChevronRight } from 'lucide-react';
      ...
      <section className="relative text-white py-24 px-6 rounded-b-[40px] shadow-xl mb-16 overflow-hidden bg-gray-900">
        ...
        {slides.map((slide, index) => (
          ...
          >
            ...
            />
            {/* Lighter Gradient Overlay with minimal blur */}
              ...
              latestJobs.map((job: any) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-4 min-w-0">
                    {/* Bigger & Professional Company Logo */}
